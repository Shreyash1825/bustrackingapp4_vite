  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background " +
        ...
        "group-[.destructive]:bg-muted/40 group-[.destructive]:hover:bg-destructive/30 " +
        "group-[.destructive]:border-destructive group-[.destructive]:text-destructive-foreground group-[.destructive]:hover:text-destructive",
      className
    )}
    {...props}
  />
  ...
  <ToastPrimitives.Close
    ...
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity " +
        ...
        "group-[.destructive]:hover:text-red-400 group-[.destructive]:focus:text-red-400",
      className
    )}
    {...props}
  >
